...
import demo.javahero.config.audit.AuditEventConverter;
import demo.javahero.domain.PersistentAuditEvent;
...
import static demo.javahero.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
